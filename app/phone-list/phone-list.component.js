        ...
        for (var j = 0; j < users.length; j++) {
          ...
          if (users[j].general) {
            if (users[j] && users[j].general && users[j].general.firstName && users[j].general.lastName) {
              ...
              renderedUser.title = 'img/img' + (j+1) + '.jpg';
              renderedUser.fullName =   users[j].general.firstName + ' ' + users[j].general.lastName;
          ...
          switch ((j + 1) % scope.numPerPage) {
            ...
            case 4:
              ...
              renderedUser.classImage = "childimageWidthBig";
